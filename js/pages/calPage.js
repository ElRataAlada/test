...
export function calPage() {
    ...
    main.innerHTML += ' <div class="popup" id="stat-popup"> <div class="history-popup"><h2>Статистика</h2><div class="main"><div id="main-cal-chart" class="chart"></div><div class="main-footer"><div class="chart-options"> <label class = "chart-option"><input class="option-chart" type="radio" checked name="option" value="7"/><p>7 д.</p></label><label class = "chart-option"><input class="option-chart" type="radio" name="option" value="30"/><p>30 д.</p></label><label class = "chart-option"><input class="option-chart" type="radio" name="option" value="365"/><p>1 рік</p></label><label class = "chart-option"><input class="option-chart" type="radio" name="option" value="0"/><p>Весь час</p></label></div><div class="chart-legend"> <div>Було випито</div><div>Ціль</div></div></div></div></div><div>'
